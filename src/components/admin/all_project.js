...
class All_project extends Component {
    ...
    fetchProjet = () => {
        fetch(API_URL + 'all-admin-project/')
                    ...
                    <div className="row">
                        {
                            ...
                            ?
                            <div style={{display: 'flex',  justifyContent:'center', alignItems:'center'}}>
                                <h1>Aucun Projet n'est enregistré pour l'instant</h1>
                            </div>
                            :
                                ...
                                return (
                                    <div key={index} className="card" style={{width: '20rem', margin: 10}}>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <p className="card-text" style={{minHeight: 100}} >{item.description.substring(0, 145)}... </p>
                                            <hr/>
